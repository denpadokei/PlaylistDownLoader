...
namespace PlaylistDownLoader.Networks
{
    ...
    internal static class WebClient
    {
        ...
        private static void Connect()
        {
            ...
            _client.DefaultRequestHeaders.UserAgent.TryParseAdd($"{Plugin.Name}/{Assembly.GetExecutingAssembly().GetName().Version}");
        }
            ...
            try {
                ...
                do {
                    try {
                        ...
                        if (retryCount != 0) {
                            await Task.Delay(timeWait.Next(10000, 30000));
                        }
                        retryCount++;
